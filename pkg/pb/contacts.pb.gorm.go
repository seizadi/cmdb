...
type ProfileORM struct {
	AccountID string
	Contacts  []*ContactORM `gorm:"foreignkey:ProfileId"`
	Groups    []*GroupORM   `gorm:"foreignkey:ProfileId"`
...
type GroupORM struct {
	AccountID string
	Contacts  []*ContactORM `gorm:"many2many:group_contacts;jointable_foreignkey:group_id;association_jointable_foreignkey:contact_id"`
	Id        int64         `gorm:"type:serial;primary_key"`
	Name      string
	Notes     string
...
func DefaultReadProfile(ctx context.Context, in *Profile, db *gorm1.DB, fs *query1.FieldSelection) (*Profile, error) {
	if in == nil {
	...
	if db, err = gorm2.ApplyFieldSelection(ctx, db, fs, &ProfileORM{}); err != nil {
		return nil, err
	}
...
func DefaultPatchProfile(ctx context.Context, in *Profile, updateMask *field_mask1.FieldMask, db *gorm1.DB) (*Profile, error) {
	...
	pbReadRes, err := DefaultReadProfile(ctx, &Profile{Id: in.GetId()}, db, nil)
	if err != nil {
		return nil, err
	}
	pbObj = *pbReadRes
...
func DefaultReadContact(ctx context.Context, in *Contact, db *gorm1.DB, fs *query1.FieldSelection) (*Contact, error) {
	if in == nil {
	...
	if db, err = gorm2.ApplyFieldSelection(ctx, db, fs, &ContactORM{}); err != nil {
		return nil, err
	}
...
func DefaultPatchContact(ctx context.Context, in *Contact, updateMask *field_mask1.FieldMask, db *gorm1.DB) (*Contact, error) {
	...
	pbReadRes, err := DefaultReadContact(ctx, &Contact{Id: in.GetId()}, db, nil)
	if err != nil {
		return nil, err
	}
	pbObj = *pbReadRes
...
func (m *ProfilesDefaultServer) Read(ctx context.Context, in *ReadProfileRequest) (*ReadProfileResponse, error) {
	...
	res, err := DefaultReadProfile(ctx, &Profile{Id: in.GetId()}, db, in.Fields)
	if err != nil {
		return nil, err
	}
...
func (m *ProfilesDefaultServer) Update(ctx context.Context, in *UpdateProfileRequest) (*UpdateProfileResponse, error) {
	...
	if in.GetFields() == nil {
		...
		res, err = DefaultPatchProfile(ctx, in.GetPayload(), in.GetFields(), db)
	}
	if err != nil {
		return nil, err
	}
...
func (m *ProfilesDefaultServer) List(ctx context.Context, in *ListProfileRequest) (*ListProfilesResponse, error) {
	...
	out := &ListProfilesResponse{Results: res, Page: resPaging}
...
// ListByProfile ...
func (m *GroupsDefaultServer) ListByProfile(ctx context.Context, in *ListGroupsByProfileRequest) (*ListGroupsResponse, error) {
...
func (m *ContactsDefaultServer) Read(ctx context.Context, in *ReadContactRequest) (*ReadContactResponse, error) {
	...
	res, err := DefaultReadContact(ctx, &Contact{Id: in.GetId()}, db, in.Fields)
	if err != nil {
		return nil, err
	}
...
func (m *ContactsDefaultServer) List(ctx context.Context, in *ListContactRequest) (*ListContactsResponse, error) {
	...
	out := &ListContactsResponse{Results: res, Page: resPaging}
...
// ListByProfile ...
func (m *ContactsDefaultServer) ListByProfile(ctx context.Context, in *ListContactsByProfileRequest) (*ListContactsResponse, error) {
	return &ListContactsResponse{}, nil
}

// ListByGroup ...
func (m *ContactsDefaultServer) ListByGroup(ctx context.Context, in *ListContactsByGroupRequest) (*ListContactsResponse, error) {
	return &ListContactsResponse{}, nil
}
