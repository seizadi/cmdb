...
func DefaultCreateCloudProvider(ctx context.Context, in *CloudProvider, db *gorm1.DB) (*CloudProvider, error) {
	if in == nil {
		return nil, errors.New("Nil argument to DefaultCreateCloudProvider")
	}
	ormObj, err := in.ToORM(ctx)
	if err != nil {
		return nil, err
	}
	if hook, ok := interface{}(&ormObj).(CloudProviderORMWithBeforeCreate); ok {
		if db, err = hook.BeforeCreate(ctx, db); err != nil {
			return nil, err
		}
	}
	...
	if hook, ok := interface{}(&ormObj).(CloudProviderORMWithAfterCreate); ok {
		if err = hook.AfterCreate(ctx, db); err != nil {
			return nil, err
		}
	}
...
type CloudProviderORMWithBeforeCreate interface {
	BeforeCreate(context.Context, *gorm1.DB) (*gorm1.DB, error)
}
type CloudProviderORMWithAfterCreate interface {
	AfterCreate(context.Context, *gorm1.DB) error
}
...
func DefaultReadCloudProvider(ctx context.Context, in *CloudProvider, db *gorm1.DB, fs *query1.FieldSelection) (*CloudProvider, error) {
	if in == nil {
		return nil, errors.New("Nil argument to DefaultReadCloudProvider")
	}
	ormObj, err := in.ToORM(ctx)
	if err != nil {
		return nil, err
	...
	if ormObj.Id == 0 {
		return nil, errors.New("DefaultReadCloudProvider requires a non-zero primary key")
	}
...
func DefaultDeleteCloudProvider(ctx context.Context, in *CloudProvider, db *gorm1.DB) error {
	if in == nil {
		return errors.New("Nil argument to DefaultDeleteCloudProvider")
	}
	ormObj, err := in.ToORM(ctx)
	if err != nil {
		return err
	...
	if hook, ok := interface{}(&ormObj).(CloudProviderORMWithBeforeDelete); ok {
		if db, err = hook.BeforeDelete(ctx, db); err != nil {
			return err
		}
	}
	...
	if hook, ok := interface{}(&ormObj).(CloudProviderORMWithAfterDelete); ok {
		err = hook.AfterDelete(ctx, db)
	}
	return err
}

type CloudProviderORMWithBeforeDelete interface {
	BeforeDelete(context.Context, *gorm1.DB) (*gorm1.DB, error)
}
type CloudProviderORMWithAfterDelete interface {
	AfterDelete(context.Context, *gorm1.DB) error
}
...
func DefaultStrictUpdateCloudProvider(ctx context.Context, in *CloudProvider, db *gorm1.DB) (*CloudProvider, error) {
	...
	if ormObj.Id == 0 {
		return nil, errors.New("Can't do overwriting update with no Id value for CloudProviderORM")
	}
...
func DefaultPatchCloudProvider(ctx context.Context, in *CloudProvider, updateMask *field_mask1.FieldMask, db *gorm1.DB) (*CloudProvider, error) {
	if in == nil {
		return nil, errors.New("Nil argument to DefaultPatchCloudProvider")
	}
...
func DefaultApplyFieldMaskCloudProvider(ctx context.Context, patchee *CloudProvider, patcher *CloudProvider, updateMask *field_mask1.FieldMask, prefix string, db *gorm1.DB) (*CloudProvider, error) {
	if patcher == nil {
		...
		return nil, errors.New("Patchee inputs to DefaultApplyFieldMaskCloudProvider must be non-nil")
	}
	var err error
	for _, f := range updateMask.Paths {
		if f == prefix+"Id" {
