...
func (m *Environment) ToORM(ctx context.Context) (EnvironmentORM, error) {
	...
	if v, err := resource1.Decode(nil, m.RegionId); err != nil {
		return to, err
	} else if v != nil {
		to.RegionId = v
	}
...
func (m *EnvironmentORM) ToPB(ctx context.Context) (Environment, error) {
	...
	if v, err := resource1.Encode(nil, m.RegionId); err != nil {
		return to, err
	} else {
		to.RegionId = v
	}
...
type ManifestORM struct {
	...
	Description  string
	Id           int64  `gorm:"type:serial;primary_key"`
	Ingress      []byte `gorm:"type:jsonb"`
	Name         string
	Repo         string
	Service      []byte    `gorm:"type:jsonb"`
	Values       []byte    `gorm:"type:jsonb"`
...
func (m *Manifest) ToORM(ctx context.Context) (ManifestORM, error) {
	...
	to.Repo = m.Repo
	to.Commit = m.Commit
	if v, err := resource1.DecodeBytes(nil, m.Values); err != nil {
		return to, err
	} else {
		to.Values = v
	}
	if v, err := resource1.DecodeBytes(nil, m.Service); err != nil {
		return to, err
	} else {
		to.Service = v
	}
	if v, err := resource1.DecodeBytes(nil, m.Ingress); err != nil {
		return to, err
	} else {
		to.Ingress = v
	}
...
func (m *ManifestORM) ToPB(ctx context.Context) (Manifest, error) {
	...
	to.Repo = m.Repo
	to.Commit = m.Commit
	if v, err := resource1.Encode(nil, m.Values); err != nil {
		return to, err
	} else {
		to.Values = v
	}
	if v, err := resource1.Encode(nil, m.Service); err != nil {
		return to, err
	} else {
		to.Service = v
	}
	if v, err := resource1.Encode(nil, m.Ingress); err != nil {
		return to, err
	} else {
		to.Ingress = v
	}
