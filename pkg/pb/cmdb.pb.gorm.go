...
func (m *ApplicationInstance) ToORM(ctx context.Context) (ApplicationInstanceORM, error) {
	...
	if v, err := resource1.Decode(nil, m.ChartVersionId); err != nil {
		return to, err
	} else if v != nil {
		to.ChartVersionId = v
	}
...
func (m *ApplicationInstanceORM) ToPB(ctx context.Context) (ApplicationInstance, error) {
	...
	if v, err := resource1.Encode(nil, m.ChartVersionId); err != nil {
		return to, err
	} else {
		to.ChartVersionId = v
	}
...
func (m *Value) ToORM(ctx context.Context) (ValueORM, error) {
	...
	if v, err := resource1.Decode(nil, m.AwsRdsInstanceId); err != nil {
		return to, err
	} else if v != nil {
		to.AwsRdsInstanceId = v
	}
...
func (m *ValueORM) ToPB(ctx context.Context) (Value, error) {
	...
	if v, err := resource1.Encode(nil, m.AwsRdsInstanceId); err != nil {
		return to, err
	} else {
		to.AwsRdsInstanceId = v
	}
