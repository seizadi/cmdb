...
var CmdbMethodsRequireFieldSelectionValidation = map[string][]string{
	...
	"/api.cmdb.ApplicationInstances/Read": {
		...
		"containers.digest",
		"containers.application_instance_id",
		"containers",
		"environment_id",
		"deployment.id",
		"deployment.name",
	...
	"/api.cmdb.Environments/Read": {
		...
		"application_instances.app_name",
		"application_instances.repo",
		"application_instances.version_tag_id",
		"application_instances.manifest_id",
