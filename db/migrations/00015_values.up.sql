...
ALTER TABLE app_region_configs ADD COLUMN value_id int REFERENCES values(id) ON DELETE SET NULL;
ALTER TABLE app_stage_configs ADD COLUMN value_id int REFERENCES values(id) ON DELETE SET NULL;
ALTER TABLE app_environment_configs ADD COLUMN value_id int REFERENCES values(id) ON DELETE SET NULL;
